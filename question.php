...
<div style="width: 90%; top: 40px; margin: auto">
	...
	<div id="paginator" class="pagination">
		<ul>
			<li id="1"
				onclick="GetQuestion('question.php', <?php echo $_SESSION['stage']; ?>, '1', ace.edit('content').getValue(), this.id);"><a href="#" id="a1">1</a></li>
			<li id="2"
				onclick="GetQuestion('question.php', <?php echo $_SESSION['stage']; ?>, '2', ace.edit('content').getValue(), this.id);"><a href="#" id="a2">2</a></li>
                    <?php
...
<?php
	...
	elseif ($_POST ['op'] == 5) {
		$t = $_POST ['timeLeft'];
		$mysqli->query ( "INSERT INTO `answers` (teamid, stageid, questionid, ans, time) VALUES('{$_SESSION['teamid']}', '{$_SESSION['stage']}', '{$_SESSION['questionid']}', '" . $mysqli->real_escape_string ( $_POST ['ans'] ) . "','{$t}') ON DUPLICATE KEY UPDATE teamid = VALUES(teamid), stageid = VALUES(stageid), questionid = VALUES(questionid), ans = VALUES(ans), time = VALUES(time)" );
