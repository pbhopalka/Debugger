...
/*
 * class.Diff.php A class containing a diff implementation Created by Stephen Morley - http://stephenmorley.org/ - and released under the terms of the CC0 1.0 Universal legal code: http://creativecommons.org/publicdomain/zero/1.0/legalcode
 */
...
class Diff {
	...
	/*
	 * Returns the diff for two files. The parameters are: $file1 - the path to the first file $file2 - the path to the second file $compareCharacters - true to compare characters, and false to compare lines; this optional parameter defaults to false
	 */
	...
	/*
	 * Returns the table of longest common subsequence lengths for the specified sequences. The parameters are: $sequence1 - the first sequence $sequence2 - the second sequence $start - the starting index $end1 - the ending index for the first sequence $end2 - the ending index for the second sequence
	 */
	...
	/*
	 * Returns a diff as a string, where unmodified lines are prefixed by ' ', deletions are prefixed by '- ', and insertions are prefixed by '+ '. The parameters are: $diff - the diff array $separator - the separator between lines; this optional parameter defaults to "\n"
	 */
	...
	/*
	 * Returns a diff as an HTML string, where unmodified lines are contained within 'span' elements, deletions are contained within 'del' elements, and insertions are contained within 'ins' elements. The parameters are: $diff - the diff array $separator - the separator between lines; this optional parameter defaults to '<br>'
	 */
	...
	/*
	 * Returns a diff as an HTML table. The parameters are: $diff - the diff array $indentation - indentation to add to every line of the generated HTML; this optional parameter defaults to '' $separator - the separator between lines; this optional parameter defaults to '<br>'
	 */
	...
	/*
	 * Returns the content of the cell, for use in the toTable function. The parameters are: $diff - the diff array $indentation - indentation to add to every line of the generated HTML $separator - the separator between lines $index - the current index, passes by reference $type - the type of line
	 */
