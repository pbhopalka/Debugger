...
<form action="" method="POST">
	<label for="stage">Stage ID </label> <input type="text" name="stageid"
		id="stage" required /><br> <label for="type">Type </label> <input
		type="text" name="type" id="type" required /><br> <label for="time">Time
	</label> <input type="text" name="time" id="time" required /><br> <input
